...
echo " "
echo -e "\e[33m Welcome to [\e[1m\e[32mDEKU VIRUS\e[21m\e[31m V 2.3\e[33m]"
echo " "
sleep 1
echo -e "\e[1m\e[33m============================================\e[21m"
echo " "
echo -e "\e[33m•••Script by \e[36mTHE DEKU VIRUS\e[33m•••"
echo " "
echo -e "\e[1m\e[33m••••••••••••••••••••••••••••••••••••••••••••\e[21m"
echo " "
sleep 1
...
echo -e "\e[1m\e[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\e[21m"
    echo " " 
                    echo -e "\e[36m >>> STARTING DEKU VIRUS..."
                    echo " "
                    sleep 2
